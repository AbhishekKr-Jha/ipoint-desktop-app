...
Vue.component('header-component',{
    ...
    <div  class="relative flex flex-col gap-30 justify-center items-start  nav-container"  > 

    <div style="height:60px;width:60px;" class="w-full bg-red " > f </div>

<div v-for="item in sideBarMenuList" :key="item.title"  @click="handle_changeSection(item.section)"   :style="{ gap: '2px', width: isSideBarOpen ? '250px' : '50px' }" class=" text-white rounded-lg flex justify-start items-center  pointer text-lg nav-item"  >
